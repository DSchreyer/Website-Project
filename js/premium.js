document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      "hero.title": "Data science for oncology, built for clarity and impact.",
      "hero.lead": "I design bioinformatics workflows and analytics systems for pharma and translational research, with focus on reproducibility, quality, and clear interpretation.",
    ...
    de: {
      ...
      "hero.title": "Data Science für Onkologie – klar, präzise und belastbar.",
      "hero.lead": "Ich entwickle Bioinformatik-Workflows und Analytics-Systeme für Pharma und translationale Forschung – mit Fokus auf Reproduzierbarkeit, Qualität und klare Interpretation.",
